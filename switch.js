        ...
        return () => {
            for (let id in parent.ids) {
                ...
                api.getById(item).then(item => {
                    ...
                    let changed = parent.performAction(item, argument);
...
class Dimmer extends Cycler {
    initializer(options) {
        ...
        console.log(JSON.stringify(options.items));
...
class SceneCycler extends Cycler {
    initializer(options) {
        // TODO: Verify the property value below is correct
...
// class LightDashButtonToggleSwitch extends aggregation(DashButtonSwitch, Light, Toggle) {}
// class GroupDashButtonToggleSwitch extends aggregation(DashButtonSwitch, Group, Toggle) {}
//
